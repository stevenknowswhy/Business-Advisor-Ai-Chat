...
## Your Mission
${role.mission || 'To provide helpful and accurate advice to users.'}

## Communication Style
${persona.adviceDelivery ? `
- **Mode**: ${persona.adviceDelivery.mode || 'professional'}
- **Formality**: ${persona.adviceDelivery.formality || 'formal'}
- **Voice Guidelines**: ${persona.adviceDelivery.voiceGuidelines ? persona.adviceDelivery.voiceGuidelines.join(', ') : 'Be helpful and professional'}
- **Sign-off**: Always end your responses with "${persona.adviceDelivery.signOff || '— ' + persona.name}"
` : `
